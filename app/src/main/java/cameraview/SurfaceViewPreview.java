...
class SurfaceViewPreview extends PreviewImpl {
    ...
    SurfaceViewPreview(Context context, ViewGroup parent) {
        final View view = new SurfaceView(context);//View.inflate(context, R.layout.surface_view, parent);
        parent.addView(view, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        mSurfaceView = (SurfaceView) view;//view.findViewById(R.id.surface_view);

...
//                R.style.Widget_CameraView);
        ...
        setFacing(FACING_BACK/*a.getInt(R.styleable.CameraView_facing, FACING_BACK)*/);
...
//        }
        ...
        //setFlash(Constants.FLASH_AUTO/*a.getInt(R.styleable.CameraView_flash, Constants.FLASH_AUTO)*/);
        //a.recycle();
        // Display orientation detector
        mDisplayOrientationDetector = new DisplayOrientationDetector(context) {
            @Override
            public void onDisplayOrientationChanged(int displayOrientation) {
                if (!hasSetDisplayOrientation) {
    ...
    private boolean hasSetDisplayOrientation = false;

    public boolean setDisplayOrientation(int displayOrientation) {
        hasSetDisplayOrientation = true;
        if (mImpl != null) {
            mImpl.setDisplayOrientation(displayOrientation);
            return true;
        }
    ...
    public void setPictureQuality(int quality) {
        if (mImpl != null) {
            mImpl.setPictureQuality(quality);
        }
    }
    ...
    /**
     * @return Camera(old) or CameraDevice
     */
    public Object getCamera() {
        if (mImpl != null) {
            if (mImpl.getCamera1() == null) {
                return mImpl.getCamera2();
            }
            return mImpl.getCamera1();
        }
        return null;
    }

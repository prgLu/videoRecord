...
class TextureViewPreview extends PreviewImpl {
    ...
    TextureViewPreview(Context context, ViewGroup parent) {
        final View view = new TextureView(context);//View.inflate(context, R.layout.texture_view, parent);
        parent.addView(view, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
        mTextureView = (TextureView) view;//view.findViewById(R.id.texture_view);
